    ...
    <section className="py-32 relative text-wedding-on-dark bg-wedding-dark">
      ...
      <div className="max-w-2xl mx-auto px-4 relative z-10">
        <StaggerRevealOnScroll direction="up" width="100%" staggerDelay={0.16} className="w-full">
          ...
          <StaggerRevealOnScroll direction="up" width="100%" staggerDelay={0.12} className="grid gap-6 font-heading">
            {bankAccounts.map((account, index) => (
              <div key={index} className="p-8 border border-wedding-on-dark/10 bg-wedding-on-dark/5 backdrop-blur-md rounded-xl relative group hover:border-wedding-accent/40 hover:-translate-y-1 transition-all duration-300 h-full overflow-hidden">
