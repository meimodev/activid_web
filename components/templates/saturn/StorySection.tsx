...
export function StorySection({ stories, heading }: StorySectionProps) {
    ...
    return (
        <section className="py-32 relative text-center border-b border-wedding-accent/10 text-wedding-on-dark">
            ...
            <div className="container mx-auto px-4 max-w-3xl">
                ...
                <div className="relative">
                    ...
                    {/* End Ornament */}
                    <div className="mt-16 relative z-10 bg-wedding-dark inline-block p-4 rounded-full border border-wedding-accent/20">
                        <SatrunIcon />
                    </div>
                </div>
            </div>
