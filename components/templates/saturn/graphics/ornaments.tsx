    ...
    return (
        <div className="w-full flex items-center justify-center py-16 opacity-70">
            <div className="relative flex items-center gap-1">
                <div className="h-px w-24 bg-gradient-to-r from-transparent via-wedding-accent-2 to-transparent" />
                <motion.div
                    initial={{ width: 0 }}
                    whileInView={{ width: "100px" }}
                    className="h-[2px] bg-wedding-accent-2/50"
                />
                <div className="w-2 h-2 border border-wedding-accent-2 rotate-45" />
                <motion.div
                    initial={{ width: 0 }}
                    whileInView={{ width: "100px" }}
                    className="h-[2px] bg-wedding-accent-2/50"
                />
                <div className="h-px w-24 bg-gradient-to-l from-transparent via-wedding-accent-2 to-transparent" />
            </div>
        </div>
    );
}
...
export function StarDivider() {
    return (
        <div className="flex items-center justify-center py-8 gap-2">
            <div className="h-px w-10 bg-wedding-accent-2/50" />
