...
export function TitleSection({ hosts, date, heading }: TitleSectionProps) {
  ...
  <span className="font-mono text-[10px] text-cyan-400 tracking-[0.2em] uppercase">
  ...
  <h2 className="font-heading text-sm uppercase tracking-[0.5em] text-cyan-100 text-center font-semibold drop-shadow-[0_0_10px_rgba(34,211,238,0.5)]">
  {heading}
  </h2>
  ...
  {/* Decorative Brackets */}
  <div className="absolute -top-6 -left-6 w-12 h-12 border-t border-l border-cyan-500/30 rounded-tl-xl hidden " />
  <div className="absolute -bottom-6 -right-6 w-12 h-12 border-b border-r border-cyan-500/30 rounded-br-xl hidden " />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <RevealOnScroll direction="down" width="100%">
          <div className="flex flex-col items-center mb-16">
            <SatrunIcon />
            <h2 className="font-heading text-2xl uppercase tracking-[0.3em] text-[#D4AF37] mb-2 text-center text-glow">
              {heading}
            </h2>
          ...
          {cards.map((e, idx) => (
            ...
            >
              <div className="h-full bg-white/5 backdrop-blur-xl border border-white/10 rounded-lg p-10 relative overflow-hidden group hover:border-[#D4AF37]/30 transition-all duration-500 hover:shadow-[0_0_30px_rgba(212,175,55,0.1)]">
                ...
                <h3 className="font-heading text-xl uppercase tracking-[0.3em] text-[#D4AF37] mb-6">
                  {e.title}
                </h3>
                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-4 border-t border-white/10">
                    <p className="font-heading text-lg text-white">{e.venue}</p>
                    <p className="font-body text-sm text-white/50 mt-2">{e.address}</p>
                  </div>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-2 mt-6 px-6 py-3 bg-[#D4AF37]/10 border border-[#D4AF37]/20 rounded-full text-[#D4AF37] hover:bg-[#D4AF37]/20 transition-all duration-300"
                  >
                    <NavigateArrowIcon />
...
export function ConfirmationSection({ invitationId, rsvpDeadline }: ConfirmationSectionProps) {
  ...
  <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-10 rounded-2xl shadow-2xl relative overflow-hidden">
  {/* Decorative glow */}
