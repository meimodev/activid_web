...
export function Hero({ onOpen, couple, date, subtitle, coverImage }: HeroProps) {
  ...
  <span className="font-heading text-lg tracking-[0.4em] uppercase mb-6 block text-white/80">
  {subtitle}
  </span>
  </FloatingParallax>
  ...
  <FloatingParallax speed={0.1}>
  <p className="font-heading text-xl tracking-[0.2em] text-wedding-accent-light border-y border-white/20 py-4 inline-block px-12 backdrop-blur-sm bg-white/5">
  {date}
  </p>
  </FloatingParallax>
  </motion.div>
  ...
  font-heading uppercase tracking-[0.3em] text-xs text-white/90 hover:bg-white hover:text-wedding-dark 
