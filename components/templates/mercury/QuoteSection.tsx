        ...
        <div className="relative mx-auto w-full overflow-hidden rounded-2xl bg-white px-6 py-16  shadow-[0_22px_70px_rgba(44,11,19,0.12)]">
          ...
          <div className="relative z-10 mx-auto max-w-[980px]">
            <RevealOnScroll
              ...
              width="100%"
            >
              <blockquote className="font-poppins text-[14px] pt-12 px-8 leading-tight text-[#9a6a74] tracking-wide">
                {quote.text}
              </blockquote>
            </RevealOnScroll>
            ...
            <RevealOnScroll
              ...
              width="100%"
            >
              <p className="mt-4 font-poppins-bold text-[16px] text-[#9a6a74]">
                {quote.author}
              </p>
            </RevealOnScroll>
          </div>
