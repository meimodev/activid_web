  ...
  return (
    <div className="relative h-screen w-full overflow-hidden bg-[#612A35]">
      <motion.div
        ...
        animate={
          isOpening ? { opacity: 0, scale: 1.02 } : { opacity: 0.16, scale: 1 }
        }
        transition={
          isOpening
            ? { duration: 0.64, ease: revealEase }
      ...
      <motion.div
        ...
        transition={
          isOpening
            ? { duration: 0.56, delay: 0.06, ease: revealEase }
      ...
      <motion.div
        ...
        transition={
          isOpening
            ? { duration: 0.72, delay: 0.12, ease: revealEase }
            : { duration: 0.95, delay: 0.18, ease: revealEase }
        }
      >
        <motion.div
      ...
      <motion.div
        ...
        transition={
          isOpening
            ? { duration: 0.72, delay: 0.3, ease: revealEase }
            : { duration: 0.95, delay: 0.32, ease: revealEase }
        }
      >
        <motion.div
          className="h-full w-full bg-contain bg-no-repeat"
      ...
      <div className="relative z-30 mx-auto flex h-full w-full max-w-[610px] items-center justify-center p-3">
        <motion.div
          style={{ scale }}
          className="relative w-full h-full flex origin-center items-center justify-center"
        >
          <motion.div
            ...
            transition={
              isOpening
                ? { duration: 0.44, delay: 0.42, ease: revealEase }
                : { duration: 0.95, delay: 0.48, ease: revealEase }
            }
