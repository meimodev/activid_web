...
export function StorySection({
 ...
 return (
  <section className="relative overflow-hidden bg-[#12060a] py-24 text-white ">
  ...
  <h2 className="font-tan-mon-cheri text-[60px] leading-none text-white ">
  {heading}
  </h2>
  </RevealOnScroll>
  ...
  <div className="relative mx-auto -translate-y-6 w-full rounded-[38px] bg-[#612A35]/92 px-7 py-12 text-center shadow-[0_22px_55px_rgba(12,3,6,0.35)] ring-1 ring-white/10 z-0">
