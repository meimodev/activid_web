...
export function ClassicFlourishDivider() {
  ...
  >
  <path d="M8 17h86" stroke="currentColor" strokeOpacity="0.45" strokeWidth="1.6" strokeLinecap="round" />
  <path d="M146 17h86" stroke="currentColor" strokeOpacity="0.45" strokeWidth="1.6" strokeLinecap="round" />
  <path
...
export function StoryFloralBand() {
  ...
  >
  <path d="M22 44c24-16 54-24 86-24 32 0 62 8 86 24" stroke="currentColor" strokeOpacity="0.35" strokeWidth="2" />
  <path
...
export function OrnamentDivider() {
  ...
  <stop stopColor="var(--invitation-accent-2)" stopOpacity="0" />
  <stop offset="0.18" stopColor="var(--invitation-accent-2-light)" stopOpacity="0.55" />
  <stop offset="0.5" stopColor="var(--invitation-on-dark)" stopOpacity="0.55" />
  <stop offset="0.82" stopColor="var(--invitation-accent-light)" stopOpacity="0.55" />
  <stop offset="1" stopColor="var(--invitation-accent-2)" stopOpacity="0" />
  </linearGradient>
  </defs>
...
export function WaveDivider({ flip }: { flip?: boolean }) {
  ...
  <stop stopColor="var(--invitation-accent-2)" stopOpacity="0" />
  <stop offset="0.18" stopColor="var(--invitation-accent-2)" stopOpacity="0.18" />
  <stop offset="0.52" stopColor="var(--invitation-on-dark)" stopOpacity="0.10" />
  <stop offset="0.82" stopColor="var(--invitation-accent)" stopOpacity="0.16" />
  <stop offset="1" stopColor="var(--invitation-accent-2)" stopOpacity="0" />
  </linearGradient>
  </defs>
