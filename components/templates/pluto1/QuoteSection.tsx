...
export function QuoteSection({ quote }: QuoteSectionProps) {
  ...
  return (
    <section className="relative overflow-hidden bg-white pt-4 text-[#2B2424]">
      <div className="container mx-auto px-4 relative z-10">
        <div className="relative mx-auto max-w-3xl translate-y-3">
          <div className="absolute -inset-x-8 -inset-y-10 rounded-[28px]" />
          <div className="relative overflow-hidden rounded-t-[28px] border-2 border-[#535b42]/60 px-6 py-14 text-center shadow-[0_20px_60px_rgba(0,0,0,0.12)] ">
            <div className="pointer-events-none absolute inset-0">
              <div className="absolute inset-[10px] rounded-t-[20px] border-[#535b42]/35 bg-[#4E5A4A]/70" />
            </div>
