  ...
  return (
    <footer className="relative mt-8 overflow-hidden bg-wedding-dark border-t border-wedding-on-dark/5">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <motion.div
          className="absolute left-[18%] top-[32%] w-[260px] h-[260px] -translate-x-1/2 -translate-y-1/2 rounded-[999px] border border-wedding-on-dark/5"
          animate={{ rotate: -360 }}
          transition={{ duration: 55, repeat: Infinity, ease: "linear" }}
        >
          <div className="absolute top-2 right-10 w-2.5 h-2.5 rounded-full bg-wedding-accent/70 shadow-[0_0_18px_rgba(192,132,252,0.55)]" />
        </motion.div>

        <motion.div
          className="absolute left-[82%] top-[58%] w-[320px] h-[320px] -translate-x-1/2 -translate-y-1/2 rounded-[999px] border border-wedding-on-dark/5"
          animate={{ rotate: 360 }}
          transition={{ duration: 64, repeat: Infinity, ease: "linear" }}
        >
          <div className="absolute bottom-3 left-1/2 w-2 h-2 -translate-x-1/2 rounded-full bg-wedding-accent-2-light/80 shadow-[0_0_18px_rgba(165,180,252,0.55)]" />
        </motion.div>

        <motion.div
          className="absolute left-1/2 top-1/2 w-[520px] h-[520px] -translate-x-1/2 -translate-y-1/2 rounded-[999px] border border-wedding-on-dark/5"
          animate={{ rotate: 360 }}
          transition={{ duration: 42, repeat: Infinity, ease: "linear" }}
        >
          <div className="absolute top-0 left-1/2 w-3 h-3 -translate-x-1/2 bg-wedding-on-dark rounded-full blur-[2px] shadow-[0_0_15px_white]" />
          <div className="absolute bottom-8 left-10 w-2 h-2 rounded-full bg-wedding-accent-2/80 shadow-[0_0_18px_rgba(34,211,238,0.65)]" />
        </motion.div>
        ...
        <motion.div
          className="absolute top-[10%] left-[-25%] w-[45%] h-[2px] bg-linear-to-r from-transparent via-wedding-accent-2-light/80 to-transparent opacity-0"
        ...
        <motion.div
          className="absolute -bottom-40 left-1/4 w-[520px] h-[520px] -translate-x-1/2 rounded-full bg-wedding-accent-2/10 blur-3xl"
          animate={{ x: [0, 26, 0], y: [0, -18, 0], opacity: [0.35, 0.55, 0.35] }}
          transition={{ duration: 18, repeat: Infinity, ease: "easeInOut" }}
        />

        <motion.div
          className="absolute -top-56 left-3/4 w-[520px] h-[520px] -translate-x-1/2 rounded-full bg-wedding-accent/10 blur-3xl"
      ...
      <div className="relative px-6 py-12 ">
        <div className="max-w-3xl mx-auto text-center text-wedding-on-dark">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-wedding-dark/40 border border-wedding-on-dark/10 text-xs font-mono text-wedding-on-dark/80 backdrop-blur-md relative overflow-hidden">
          ...
          <VenusReveal direction="up" width="100%" delay={0.35}>
            <h3
              className={`mt-4 ${venusScript.className} text-5xl bg-linear-to-r from-wedding-accent via-wedding-accent-2-light to-wedding-accent-2 bg-clip-text text-transparent bg-size-[200%_auto] animate-[gradient_4s_linear_infinite]`}
              style={{
          ...
          <VenusReveal direction="up" width="100%" delay={0.75}>
            <div className="mt-7 flex items-center justify-center">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center justify-center rounded-full px-8 py-3 bg-wedding-dark/40 border border-wedding-on-dark/10 text-xs font-mono text-wedding-on-dark/80 backdrop-blur-md transition-all hover:border-wedding-accent-2/30 hover:shadow-[0_0_40px_-10px_rgba(79,70,229,0.35)]"
              >
