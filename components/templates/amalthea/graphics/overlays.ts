...
type OverlayAssets = {
  bottomTitleGraphic: string;
  heroFrame: string;
  leafSide: string;
  leafSide2: string;
  dividerFlower: string;
  frameFlower: string;
  cornerFlower: string;
  dividerFlower2: string;
  cardEventDivider: string;
  cardFlower: string;
  sprinkle: string;
  storyTop: string;
  bottomFloral: string;
...
function readInvitationCssVars() {
  ...
  return {
    ...
    sky: get("--invitation-accent-2"),
    navy: get("--invitation-dark"),
  };
}
  ...
  return {
      ...
      <svg xmlns='http://www.w3.org/2000/svg' width='1200' height='340' viewBox='0 0 1200 340'>
        <defs>
          <linearGradient id='g' x1='0' y1='0' x2='0' y2='1'>
            <stop offset='0' stop-color='${bg}' stop-opacity='0.00'/>
            <stop offset='0.68' stop-color='${sky}' stop-opacity='0.16'/>
        ...
        <path d='M0,230 C200,300 400,300 600,250 C800,200 1000,180 1200,245' fill='none' stroke='${accent}' stroke-opacity='0.26' stroke-width='4' stroke-linecap='round'/>
      </svg>
    `),
    heroFrame: svgToDataUri(`
      <svg xmlns='http://www.w3.org/2000/svg' width='520' height='520' viewBox='0 0 520 520'>
        ...
        <circle cx='260' cy='260' r='198' fill='none' stroke='${accent}' stroke-opacity='0.52' stroke-width='3'/>
    ...
    leafSide: svgToDataUri(`
      <svg xmlns='http://www.w3.org/2000/svg' width='320' height='320' viewBox='0 0 320 320'>
        ...
        <path d='M55 260 C100 160, 170 95, 275 60' fill='none' stroke='${accent}' stroke-opacity='0.45' stroke-width='4' stroke-linecap='round'/>
        <circle cx='82' cy='214' r='6' fill='${sky}' fill-opacity='0.35'/>
        <circle cx='132' cy='160' r='4' fill='${accent}' fill-opacity='0.26'/>
    ...
    leafSide2: svgToDataUri(`
      <svg xmlns='http://www.w3.org/2000/svg' width='320' height='320' viewBox='0 0 320 320'>
        ...
        <path d='M60 275 C110 170, 190 110, 295 80' fill='none' stroke='${accent}' stroke-opacity='0.34' stroke-width='4' stroke-linecap='round'/>
      </svg>
    `),
    dividerFlower: svgToDataUri(`
      <svg xmlns='http://www.w3.org/2000/svg' width='1200' height='140' viewBox='0 0 1200 140'>
        <line x1='0' y1='70' x2='1200' y2='70' stroke='${accent}' stroke-opacity='0.24' stroke-width='6' stroke-linecap='round' stroke-dasharray='10 26'/>
        <circle cx='600' cy='70' r='12' fill='${sky}' fill-opacity='0.35'/>
        <circle cx='560' cy='70' r='6' fill='${accent}' fill-opacity='0.45'/>
        <circle cx='640' cy='70' r='6' fill='${accent}' fill-opacity='0.45'/>
      </svg>
    `),
    frameFlower: svgToDataUri(`
      <svg xmlns='http://www.w3.org/2000/svg' width='520' height='520' viewBox='0 0 520 520'>
        <circle cx='260' cy='260' r='245' fill='none' stroke='${sky}' stroke-opacity='0.35' stroke-width='10'/>
        <circle cx='260' cy='260' r='230' fill='none' stroke='${accent}' stroke-opacity='0.40' stroke-width='4' stroke-dasharray='6 14' stroke-linecap='round'/>
    ...
    cornerFlower: svgToDataUri(`
      <svg xmlns='http://www.w3.org/2000/svg' width='260' height='260' viewBox='0 0 260 260'>
        ...
        <path d='M65 225 L225 65' stroke='${accent}' stroke-opacity='0.42' stroke-width='4' stroke-linecap='round'/>
        <circle cx='60' cy='200' r='8' fill='${sky}' fill-opacity='0.25'/>
      </svg>
    `),
    dividerFlower2: svgToDataUri(`
      <svg xmlns='http://www.w3.org/2000/svg' width='1200' height='140' viewBox='0 0 1200 140'>
        <line x1='0' y1='70' x2='1200' y2='70' stroke='${accent}' stroke-opacity='0.32' stroke-width='3' stroke-linecap='round'/>
    ...
    cardEventDivider: svgToDataUri(`
      <svg xmlns='http://www.w3.org/2000/svg' width='1200' height='60' viewBox='0 0 1200 60'>
        <line x1='40' y1='30' x2='1160' y2='30' stroke='${accent}' stroke-opacity='0.24' stroke-width='6' stroke-linecap='round' stroke-dasharray='8 18'/>
    ...
    cardFlower: svgToDataUri(`
      <svg xmlns='http://www.w3.org/2000/svg' width='320' height='320' viewBox='0 0 320 320'>
        ...
        <rect x='56' y='56' width='208' height='208' rx='44' fill='none' stroke='${accent}' stroke-opacity='0.40' stroke-width='4' stroke-dasharray='6 14' stroke-linecap='round'/>
      </svg>
    `),
    sprinkle: svgToDataUri(`
      <svg xmlns='http://www.w3.org/2000/svg' width='700' height='700' viewBox='0 0 700 700'>
        ...
        <g stroke='${accent}' stroke-opacity='0.24' stroke-width='3' stroke-linecap='round'>
    ...
    storyTop: svgToDataUri(`
      <svg xmlns='http://www.w3.org/2000/svg' width='1200' height='160' viewBox='0 0 1200 160'>
        ...
        <path d='M0,108 C240,60 460,30 600,70 C760,115 980,125 1200,85' fill='none' stroke='${accent}' stroke-opacity='0.34' stroke-width='3' stroke-linecap='round'/>
      </svg>
    `),
    bottomFloral: svgToDataUri(`
      <svg xmlns='http://www.w3.org/2000/svg' width='1200' height='160' viewBox='0 0 1200 160'>
        ...
        <line x1='60' y1='115' x2='1140' y2='115' stroke='${accent}' stroke-opacity='0.22' stroke-width='6' stroke-linecap='round' stroke-dasharray='10 24'/>
      </svg>
    `),
  };
}
...
export function useOverlayAssets(): OverlayAssets {
  const [assets, setAssets] = useState<OverlayAssets>(() => {
    try {
      const { bg, accent, sky, navy } = readInvitationCssVars();
      if (!bg || !accent || !sky || !navy) return EMPTY_OVERLAY_ASSETS;
      return buildOverlayAssets({ bg, accent, sky, navy });
    } catch {
  ...
  const recompute = useCallback(() => {
    const { bg, accent, sky, navy } = readInvitationCssVars();
    if (!bg || !accent || !sky || !navy) return;
    setAssets(buildOverlayAssets({ bg, accent, sky, navy }));
  }, []);
...
export const AMALTHEA_OVERLAY_ASSETS = EMPTY_OVERLAY_ASSETS;
