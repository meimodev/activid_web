  ...
  return {
    ...
    heroFrame: svgToDataUri(`
      <svg xmlns='http://www.w3.org/2000/svg' width='520' height='520' viewBox='0 0 520 520'>
        ...
        <circle cx='260' cy='260' r='198' fill='none' stroke='${onDark}' stroke-opacity='0.65' stroke-width='3'/>
    ...
    leafSide: svgToDataUri(`
      <svg xmlns='http://www.w3.org/2000/svg' width='320' height='320' viewBox='0 0 320 320'>
        ...
        <path d='M55 260 C100 160, 170 95, 275 60' fill='none' stroke='${onDark}' stroke-opacity='0.55' stroke-width='4' stroke-linecap='round'/>
    ...
    leafSide2: svgToDataUri(`
      <svg xmlns='http://www.w3.org/2000/svg' width='320' height='320' viewBox='0 0 320 320'>
        ...
        <path d='M60 275 C110 170, 190 110, 295 80' fill='none' stroke='${onDark}' stroke-opacity='0.38' stroke-width='4' stroke-linecap='round'/>
      </svg>
    `),
    dividerFlower: svgToDataUri(`
      <svg xmlns='http://www.w3.org/2000/svg' width='1200' height='140' viewBox='0 0 1200 140'>
        ...
        <circle cx='560' cy='70' r='6' fill='${onDark}' fill-opacity='0.55'/>
        <circle cx='640' cy='70' r='6' fill='${onDark}' fill-opacity='0.55'/>
      </svg>
    `),
    frameFlower: svgToDataUri(`
      <svg xmlns='http://www.w3.org/2000/svg' width='520' height='520' viewBox='0 0 520 520'>
        <circle cx='260' cy='260' r='245' fill='none' stroke='${sky}' stroke-opacity='0.35' stroke-width='10'/>
        <circle cx='260' cy='260' r='230' fill='none' stroke='${onDark}' stroke-opacity='0.55' stroke-width='4' stroke-dasharray='6 14' stroke-linecap='round'/>
    ...
    cornerFlower: svgToDataUri(`
      <svg xmlns='http://www.w3.org/2000/svg' width='260' height='260' viewBox='0 0 260 260'>
        ...
        <path d='M65 225 L225 65' stroke='${onDark}' stroke-opacity='0.45' stroke-width='4' stroke-linecap='round'/>
        <circle cx='60' cy='200' r='8' fill='${sky}' fill-opacity='0.25'/>
      </svg>
    `),
    dividerFlower2: svgToDataUri(`
      <svg xmlns='http://www.w3.org/2000/svg' width='1200' height='140' viewBox='0 0 1200 140'>
        <line x1='0' y1='70' x2='1200' y2='70' stroke='${onDark}' stroke-opacity='0.55' stroke-width='3' stroke-linecap='round'/>
    ...
    cardFlower: svgToDataUri(`
      <svg xmlns='http://www.w3.org/2000/svg' width='320' height='320' viewBox='0 0 320 320'>
        ...
        <rect x='56' y='56' width='208' height='208' rx='44' fill='none' stroke='${onDark}' stroke-opacity='0.55' stroke-width='4' stroke-dasharray='6 14' stroke-linecap='round'/>
      </svg>
    `),
    sprinkle: svgToDataUri(`
      <svg xmlns='http://www.w3.org/2000/svg' width='700' height='700' viewBox='0 0 700 700'>
        ...
        <g stroke='${onDark}' stroke-opacity='0.28' stroke-width='3' stroke-linecap='round'>
    ...
    storyTop: svgToDataUri(`
      <svg xmlns='http://www.w3.org/2000/svg' width='1200' height='160' viewBox='0 0 1200 160'>
        ...
        <path d='M0,108 C240,60 460,30 600,70 C760,115 980,125 1200,85' fill='none' stroke='${onDark}' stroke-opacity='0.55' stroke-width='3' stroke-linecap='round'/>
      </svg>
    `),
...
export function useOverlayAssets(): OverlayAssets {
  const [assets, setAssets] = useState<OverlayAssets>(() => {
    try {
      const { sky, navy, onDark } = readInvitationCssVars();
      if (!sky || !navy || !onDark) return EMPTY_OVERLAY_ASSETS;
      return buildOverlayAssets({ sky, navy, onDark });
    } catch {
  ...
  const recompute = useCallback(() => {
    const { sky, navy, onDark } = readInvitationCssVars();
    if (!sky || !navy || !onDark) return;
    setAssets(buildOverlayAssets({ sky, navy, onDark }));
  }, []);
