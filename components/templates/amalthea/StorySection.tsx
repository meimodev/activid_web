...
export function StorySection({
  ...
  return (
    <section className="relative overflow-hidden bg-wedding-bg py-12 text-wedding-dark ">
      <OverlayReveal
        delay={0.06}
        idle="none"
      ...
      >
        <motion.div
          ...
          style={{ backgroundImage: `url(${overlayAssets.dividerFlower})` }}
        ...
        <div className="mx-auto w-full max-w-[560px]">
          ...
          >
            <div className="flex items-center justify-end pb-12">
              <div className="h-px flex-1 bg-wedding-accent-2/50" />
              <div className="h-2 w-2 rounded-full bg-wedding-accent-2" />
              <h2 className="font-poppins-bold text-[34px] leading-none text-wedding-dark px-6 tracking-tight  ">
                {heading}
              </h2>
            </div>
          </RevealOnScroll>
          ...
          >
            <div className="relative mt-16 p-4">
              <div
                aria-hidden
                className="pointer-events-none absolute inset-0 rounded-[24px] border-2 border-wedding-accent-2/35 bg-wedding-bg-alt"
              />

              <div className="relative z-10 overflow-hidden rounded-[24px] border-2 border-wedding-accent-2/25 bg-wedding-bg/80">
                {heroImageUrl ? (
                  <div className="p-5">
                    <div className="relative overflow-hidden rounded-t-[20px] rounded-tl-[300px] rounded-b-[18px] border-2 border-wedding-accent-2/30 bg-wedding-bg-alt">
                    ...
                    {stories.map((story, idx) => (
                      ...
                      >
                        <div className="text-center">
                          <div className="mx-auto h-6 w-[2px] bg-wedding-accent-2 mb-2" />

                          <p className="font-poppins-bold italic text-[14px] text-wedding-accent-2">
                            {formatInvitationMonthYear(story.date)}
                          </p>
                          <p className="mt-3 font-poppins text-[13px] leading-relaxed text-wedding-dark/75">
                            {story.description}
                          </p>
                        </div>
                      </RevealOnScroll>
      ...
      >
        <motion.div
          className="h-full w-full bg-cover bg-bottom bg-no-repeat"
          style={{ backgroundImage: `url(${overlayAssets.bottomFloral})` }}
          animate={{ scale: [1, 1.02, 1], opacity: [0.92, 1, 0.92] }}
          transition={{ duration: 6.5, repeat: Infinity, ease: "easeInOut" }}
        />
      </OverlayReveal>
