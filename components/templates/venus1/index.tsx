...
function CoverOverlay({
  ...
  <h1 className={`mt-6 ${venusScript.className} text-6xl leading-none`}>
  {couple.bride.firstName}
  </h1>
  <div className="mt-2 mb-2 text-3xl opacity-90">&</div>
  <h1 className={`${venusScript.className} text-6xl leading-none`}>
...
function HeaderIntro({
  ...
  <motion.h2
  className={`mt-6 ${venusScript.className} text-6xl leading-none`}
  initial={lineHidden}
  ...
  <motion.h2
  className={`${venusScript.className} text-6xl leading-none`}
  initial={lineHidden}
  animate={isOpen ? lineShow : lineHidden}
