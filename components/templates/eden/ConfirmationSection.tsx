...
export function ConfirmationSection({
 ...
 return (
  ...
  <h2 className="font-display italic text-5xl text-wedding-dark">
  R.S.V.P
  </h2>
  <FloralDivider />
  </RevealOnScroll>
  ...
  className="py-10"
  >
  <h3 className="font-display italic text-5xl mb-4 text-wedding-dark">
  {status === "already_submitted" ? "Welcome Back" : "Thank You"}
  </h3>
  <p className="font-body text-[15px] text-wedding-text/70 mb-8">
  ...
  <div>
  <p className="font-body text-[15px] mb-8 text-wedding-text/70 italic leading-relaxed">
  {!inviteeName ? (
  ...
  <div>
  <label className="block text-[13px] uppercase tracking-[0.2em] mb-2 font-body font-bold text-wedding-dark/70">
  Name
  </label>
  <div className="w-full bg-wedding-bg/70 border border-wedding-accent/25 rounded-2xl p-4 font-body text-[15px] text-wedding-text">
  {inviteeName || "Guest"}
  </div>
  </div>
  <div>
  ...
  className="w-full bg-wedding-bg border border-wedding-accent/25 rounded-2xl p-4 focus:outline-none focus:ring-2 focus:ring-wedding-dark/15 font-body text-[15px] text-wedding-text"
  ...
  type="submit"
  disabled={status === "submitting" || !inviteeName}
  className="w-full rounded-full bg-wedding-dark text-wedding-on-dark py-4 text-[13px] font-body font-bold uppercase tracking-[0.3em] hover:bg-wedding-dark/90 transition-all duration-300 disabled:opacity-50 mt-4"
  >
  {status === "submitting" ? "Sending..." : "Confirm"}
  </button>
  {status === "error" ? (
  <p className="text-wedding-accent/80 text-[13px] text-center mt-4 font-body">
