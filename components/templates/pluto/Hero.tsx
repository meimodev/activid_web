        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <motion.button
              ...
              onClick={handleOpen}
              disabled={isOpening}
              className="mt-[clamp(0.75rem,2vh,1.5rem)] inline-flex items-center justify-center gap-3 rounded-full bg-wedding-accent px-10 py-[0.7rem] font-poppins text-sm tracking-wide text-white shadow-[0_12px_30px_rgba(0,0,0,0.18)] transition-colors hover:bg-wedding-accent/90 disabled:opacity-70"
              animate={
                isOpening
                  ? undefined
                  : {
