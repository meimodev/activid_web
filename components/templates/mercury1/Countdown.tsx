...
export function Countdown({ targetDate, photos, heading }: CountdownProps) {
  ...
  <SectionOrnament />
  <h2 className="font-serif text-3xl text-stone-800 mt-6 mb-2">
  {heading}
  </h2>
  ...
  <div className="flex justify-center gap-6 font-serif flex-wrap">
  <RevealOnScroll delay={0.1} direction="up">
  <div className="text-center min-w-[80px] ">
  <span className="text-4xl text-stone-800 block mb-2 font-light">
  {timeLeft.days}
  </span>
  <span className="text-[10px] uppercase tracking-[0.2em] text-stone-400 font-sans">Days</span>
  </div>
  </RevealOnScroll>
  <div className="text-2xl text-stone-300 font-light pt-2">:</div>
  <RevealOnScroll delay={0.2} direction="up">
  <div className="text-center min-w-[80px] ">
  <span className="text-4xl text-stone-800 block mb-2 font-light">
  {timeLeft.hours}
  </span>
  <span className="text-[10px] uppercase tracking-[0.2em] text-stone-400 font-sans">Hours</span>
  </div>
  </RevealOnScroll>
  <div className="text-2xl text-stone-300 font-light pt-2">:</div>
  ...
  <span className="text-[10px] uppercase tracking-[0.2em] text-stone-400 font-sans">Mins</span>
  </div>
  </RevealOnScroll>
  <div className="text-2xl text-stone-300 font-light pt-2">:</div>
  ...
  <span className="text-[10px] uppercase tracking-[0.2em] text-stone-400 font-sans">Secs</span>
  </div>
  </RevealOnScroll>
  </div>
  </div>
