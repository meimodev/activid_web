  ...
  return (
    <section className="h-[100svh] relative flex flex-col bg-[#612A35] text-[#fff4f6] overflow-hidden">
        ...
        <div className="mx-auto flex min-h-full w-full max-w-[920px] flex-col items-center justify-center text-center px-4 sm:px-6 pt-[clamp(56px,8vh,96px)] pb-[clamp(110px,14vh,170px)]">
                  ...
                  transition={
                    prefersReducedMotion
                      ...
                      : {
                          ...
                          delay:
                            0.12 +
                            (i % Math.max(1, marqueePhotos.length)) * 0.06,
          ...
          <div className="mt-[clamp(28px,5vh,48px)]">
            <motion.p
              ...
              transition={
                prefersReducedMotion
                  ? { duration: 0.2 }
                  : { duration: 0.85, delay: 0.22, ease: [0.2, 0.65, 0.3, 0.9] }
              }
            ...
            <motion.p
              ...
              transition={
                prefersReducedMotion
                  ? { duration: 0.2 }
                  : { duration: 0.85, delay: 0.32, ease: [0.2, 0.65, 0.3, 0.9] }
              }
            ...
            <motion.p
              ...
              transition={
                prefersReducedMotion
                  ? { duration: 0.2 }
                  : { duration: 0.85, delay: 0.42, ease: [0.2, 0.65, 0.3, 0.9] }
              }
          ...
          <motion.div
            ...
            transition={
              prefersReducedMotion
                ? { duration: 0.2 }
                : { duration: 0.85, delay: 0.54, ease: [0.2, 0.65, 0.3, 0.9] }
            }
            style={{ willChange: "transform, opacity" }}
          >
            <motion.a
      ...
      >
        <motion.g
          animate={
            prefersReducedMotion ? undefined : { x: [0, -1440], y: [0, 14, 0] }
          }
          transition={
            prefersReducedMotion
              ? undefined
        ...
        <motion.g
          animate={
            prefersReducedMotion ? undefined : { x: [0, -1440], y: [0, 10, 0] }
          }
          transition={
            prefersReducedMotion
              ? undefined
        ...
        <motion.g
          animate={
            prefersReducedMotion ? undefined : { x: [0, -1440], y: [0, 7, 0] }
          }
          transition={
            prefersReducedMotion
              ? undefined
      ...
      <div className="relative z-20 mx-auto flex w-full max-w-[640px] flex-col items-center px-4 text-center">
        <div className="flex flex-col items-center">
          <RevealOnScroll direction="none" scale={1} delay={0.12} width="100%">
            <div
              aria-hidden
              className="mx-auto h-[30px] w-[240px] bg-contain bg-center bg-no-repeat opacity-90 sm:h-[34px] sm:w-[280px]"
              style={{
...
export function EventSection({ events, heading }: EventSectionProps) {
  ...
  return (
    <section className="relative overflow-hidden bg-[#F8F4EC] py-24 text-[#612A35] sm:py-28">
      <div aria-hidden className="pointer-events-none absolute inset-0">
        <motion.div
          ...
          animate={
            prefersReducedMotion
              ? undefined
              : { x: [0, 14, 0], y: [0, -10, 0], rotate: [10, 12, 10] }
          }
          transition={
            prefersReducedMotion
              ? undefined
        ...
        <motion.div
          ...
          animate={
            prefersReducedMotion
              ? undefined
              : { x: [0, -12, 0], y: [0, 10, 0], rotate: [-12, -10, -12] }
          }
          transition={
            prefersReducedMotion
              ? undefined
        ...
        <motion.div
          ...
          animate={
            prefersReducedMotion
              ? undefined
              : { x: [0, -6, 0], y: [0, 4, 0], rotate: [0, -1.1, 0] }
          }
          transition={
            prefersReducedMotion
              ? undefined
              : { duration: 11.3, repeat: Infinity, ease: "easeInOut" }
          }
        />
      </div>
        ...
        <div className="mx-auto w-full max-w-4xl">
          ...
          >
            <div className="flex items-start gap-6 sm:gap-10">
              <div className="shrink-0">
                <p className="font-tan-mon-cheri text-[56px] leading-none text-[#612A35] sm:text-[68px]">
                  Wedding
                </p>
                <p className="-mt-3 font-stoic text-[56px] leading-none text-[#612A35] sm:text-[68px]">
                  {titleRight}
                </p>
              </div>
          ...
          <div className="mt-14 space-y-10">
            <RevealOnScroll
              ...
              width="100%"
            >
              <div className="relative overflow-visible overflow-hidden rounded-[38px] bg-[#62353f] px-8 py-12 text-center text-white shadow-[0_22px_55px_rgba(44,11,19,0.20)] ring-1 ring-white/10 sm:px-14">
                <motion.div
                  aria-hidden
                ...
                <p className="font-poppins-bold text-[22px] tracking-[0.22em] uppercase text-white/90 sm:text-[24px]">
                  {events.holyMatrimony.title}
                </p>
                <p className="mt-7 font-poppins-bold text-[20px] text-white sm:text-[26px]">
            ...
            <RevealOnScroll
              ...
              width="100%"
            >
              <div className="relative overflow-visible rounded-[38px] bg-[#62353f] px-8 py-12 text-center text-white shadow-[0_22px_55px_rgba(44,11,19,0.20)] ring-1 ring-white/10 sm:px-14">
                <motion.div
                  aria-hidden
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0">
        <motion.div
          ...
          animate={
            prefersReducedMotion
              ? undefined
              : { x: [0, 14, 0], y: [0, -8, 0], rotate: [8, 10, 8] }
          }
          transition={
            prefersReducedMotion
              ? undefined
        ...
        <motion.div
          ...
          animate={
            prefersReducedMotion
              ? undefined
              : { x: [0, -12, 0], y: [0, 10, 0], rotate: [-10, -8, -10] }
          }
          transition={
            prefersReducedMotion
              ? undefined
              : { duration: 14.5, repeat: Infinity, ease: "easeInOut" }
          }
        />
        ...
        <div className="mx-auto w-full max-w-4xl">
          <RevealOnScroll direction="none" scale={1} delay={0.1} width="100%">
            <div className="flex items-center justify-end gap-4">
              ...
              <div className="h-2 w-2 rounded-full bg-[#612A35]" />
              <h2 className="font-tan-mon-cheri text-[58px] leading-none text-[#612A35] sm:text-[66px]">
                {heading}
              </h2>
            </div>
          </RevealOnScroll>
      ...
      <div className="relative px-6 py-14">
        <div className="max-w-3xl mx-auto text-center text-white">
          ...
          <RevealOnScroll direction="up" width="100%" delay={0.35}>
            <h3 className="font-tan-mon-cheri mt-7 text-5xl md:text-6xl leading-none text-white">
              Terima kasih
            </h3>
