            ...
            <div aria-hidden className="pointer-events-none absolute inset-0">
                <div className="absolute inset-0 z-0">
                    <motion.div
                        ...
                        animate={
                            prefersReducedMotion
                                ? undefined
                                : { x: [0, 28, -14, 0], y: [0, -18, 10, 0], opacity: [0.26, 0.4, 0.3, 0.26] }
                        }
                    ...
                    <motion.div
                        ...
                        animate={
                            prefersReducedMotion
                                ? undefined
                                : { x: [0, -26, 12, 0], y: [0, 16, -10, 0], opacity: [0.2, 0.34, 0.26, 0.2] }
                        }
                    ...
                    <motion.div
                        ...
                        animate={prefersReducedMotion ? undefined : { y: [0, -22, 0], opacity: [0.18, 0.3, 0.18] }}
                ...
                <div className="absolute inset-0 z-10">
                    <motion.div
                        ...
                        animate={prefersReducedMotion ? undefined : { x: [0, 14, 0], y: [0, -8, 0], rotate: [8, 10, 8] }}
                    ...
                    <motion.div
                        ...
                        animate={prefersReducedMotion ? undefined : { x: [0, -12, 0], y: [0, 10, 0], rotate: [-10, -8, -10] }}
