...
export function Hero({ onOpen, couple, date, subtitle, coverImage, guestName }: HeroProps) {
    ...
    return (
        <div className="relative h-screen w-full overflow-hidden bg-[#612A35]">
            ...
            <div className="relative z-30 mx-auto flex h-full w-full max-w-[610px] items-center justify-center p-3 sm:p-5">
                <motion.div
                    ...
                    className="relative flex h-full w-full max-h-[750px] min-h-[500px] flex-col items-center overflow-hidden rounded-[210px] border border-[#f3d8df] bg-[#fffefe] px-6 pb-12 pt-11 text-center shadow-[0_25px_90px_rgba(44,11,19,0.5)] sm:px-10 sm:pt-14"
                >
                    ...
                    >
                        ...
                        <h1 className="relative  text-[86px]  sm:text-[106px] pb-10">
                            {groomInitial}
                        </h1>
                         <h1 className="relative self-center text-[60px]   sm:text-[106px]">
                            & 
                        </h1>
                        <h1 className="relative  text-[86px]   sm:text-[106px] pt-24">
                              {brideInitial}
                        </h1>
                    </motion.div>
                    ...
                    >
                        <p className="font-stoic text-[32px] leading-none text-[#6f4a53] sm:text-[48px]">{heading}</p>
                        <p className="mt-3 font-tan-mon-cheri text-[30px] leading-tight text-[#5f323c] sm:text-[56px]">
                            {groomName} & {brideName}
                        </p>
                        <p className="font-garet-book mt-4 text-[20px] tracking-[0.22em] text-[#5f323c] sm:text-[32px]">{date}</p>
                    </motion.div>

                    <motion.div
                        className="relative font-poppins z-10 mt-10 space-y-2 text-[#62414b] sm:mt-12"
                        initial={{ opacity: 0, y: 16 }}
                        animate={isOpening ? { opacity: 0 } : { opacity: 1, y: 0 }}
                    ...
                    >
                        ...
                        <p className="pt-2 text-2xl font-semibold tracking-wide text-[#4f2a31] sm:text-[35px]">{displayGuest}</p>
                    </motion.div>
