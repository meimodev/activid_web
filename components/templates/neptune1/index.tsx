...
function NeptuneReveal(props: ComponentProps<typeof RevealOnScroll>) {
  ...
  return (
    <RevealOnScroll
      delay={delay ?? 0.18}
      duration={prefersReducedMotion ? 0.25 : effectiveDuration}
        ...
        <NeptuneReveal direction="up" width="100%" delay={0.18}>
          <div className="flex items-start gap-4">
            <div className="leading-none">
              <div
                className={`${neptuneSerif.className} text-6xl md:text-7xl text-white/95`}
              >
      ...
      <div className="relative px-6 py-12 md:py-14">
        <div className="max-w-3xl mx-auto text-center text-white">
          ...
          <NeptuneReveal direction="up" width="100%" delay={0.75}>
            <h3
              className={`mt-4 ${neptuneScript.className} text-2xl md:text-6xl bg-linear-to-r from-indigo-400 via-purple-300 to-cyan-300 bg-clip-text text-transparent bg-size-[200%_auto] animate-[gradient_4s_linear_infinite]`}
              style={{
