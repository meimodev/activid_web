...
export function QuoteSection({ quote }: QuoteSectionProps) {
  ...
  <blockquote className="font-garet-book text-lg italic leading-loose text-wedding-dark tracking-wide relative z-10">
  {quote.text}
  </blockquote>
  ...
  <p className="font-poppins-bold text-xs uppercase tracking-[0.3em] text-wedding-text-light font-semibold">
  {quote.author}
  </p>
  </div>
  </RevealOnScroll>
